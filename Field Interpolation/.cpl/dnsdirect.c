...
/*! LOOP FOR ix=ismp TO nx BY nsmp*/
   {int ix_=(ismp_*(nx_+1) / 1 ) ;while(ix_<=((ismp_+1)*(nx_+1) / 1 )-1){
    int _16h;
int _17h;
...
_27_=_24l*Vplane__i+ix_*Vplane_i+Vplane___; {char *_26_=_24l*(ssize_t)sizeof(struct VELOCITY_)+nzd_*(ssize_t)sizeof(struct VELOCITY_)+ix_*dnsdata_39i+Vd_;int _26_1=(-1)-_24l; do{{ (*(struct VELOCITY_ *)(_26_))=(*(struct VELOCITY_ *)(_27_)); _27_ =Vplane__i+_27_;}_26_+=(ssize_t)sizeof(struct VELOCITY_);_26_1--;}while(_26_1>=0);}}{ char *_28w;
_28w=ix_*dnsdata_39i+Vd_;
{fft_5IFTU(0,dnsdata_38h,(ssize_t)sizeof(struct VELOCITY_),((char*)&(*(struct VELOCITY_ *)(_28w)).u_),0,dnsdata_38h,(ssize_t)sizeof(struct VELOCITY_),((char*)&(*(struct VELOCITY_ *)(_28w)).u_));}; {fft_5IFTU(0,dnsdata_38h,(ssize_t)sizeof(struct VELOCITY_),((char*)&(*(struct VELOCITY_ *)(_28w)).v_),0,dnsdata_38h,(ssize_t)sizeof(struct VELOCITY_),((char*)&(*(struct VELOCITY_ *)(_28w)).v_));}; {fft_5IFTU(0,dnsdata_38h,(ssize_t)sizeof(struct VELOCITY_),((char*)&(*(struct VELOCITY_ *)(_28w)).w_),0,dnsdata_38h,(ssize_t)sizeof(struct VELOCITY_),((char*)&(*(struct VELOCITY_ *)(_28w)).w_));};}
  ix_+=1;};}
  if( ismp_==0 ){ int _29l;
int _30h;
ssize_t _31st;
...
_29l=nx_+1;
_30h=nxd_-1;
_31st=_29l*dnsdata_39i;
_32i=dnsdata_39i*(_30h-_29l+1);
memset(_31st+Vd_,0,_32i);};
  {
  register int md33;
while(!((*barrier_)==(ismp_)))sigsuspend(&oldmask);
  (*barrier_)=(md33=((ismp_)+1) % (1),md33>=0?md33:md33+(1));  kill(0,SIGUSR1);
  while(!((*barrier_)<=(ismp_)))sigsuspend(&oldmask);
};
   {int iz_=(ismp_*(dnsdata_38h+1) / 1 ) ;do{{
    { char *_34w;
...
{fft_8HFTU(VVplane_l,VVplane_h,VVplane_i,((char*)&(*(struct MOMFLUX_ *)(_37w)).uu_),VVplane_l,VVplane_h,VVplane_i,((char*)&(*(struct MOMFLUX_ *)(_37w)).uu_));}; {fft_8HFTU(VVplane_l,VVplane_h,VVplane_i,((char*)&(*(struct MOMFLUX_ *)(_37w)).uv_),VVplane_l,VVplane_h,VVplane_i,((char*)&(*(struct MOMFLUX_ *)(_37w)).uv_));}; {fft_8HFTU(VVplane_l,VVplane_h,VVplane_i,((char*)&(*(struct MOMFLUX_ *)(_37w)).vv_),VVplane_l,VVplane_h,VVplane_i,((char*)&(*(struct MOMFLUX_ *)(_37w)).vv_));}; {fft_8HFTU(VVplane_l,VVplane_h,VVplane_i,((char*)&(*(struct MOMFLUX_ *)(_37w)).vw_),VVplane_l,VVplane_h,VVplane_i,((char*)&(*(struct MOMFLUX_ *)(_37w)).vw_));}; {fft_8HFTU(VVplane_l,VVplane_h,VVplane_i,((char*)&(*(struct MOMFLUX_ *)(_37w)).ww_),VVplane_l,VVplane_h,VVplane_i,((char*)&(*(struct MOMFLUX_ *)(_37w)).ww_));}; {fft_8HFTU(VVplane_l,VVplane_h,VVplane_i,((char*)&(*(struct MOMFLUX_ *)(_37w)).uw_),VVplane_l,VVplane_h,VVplane_i,((char*)&(*(struct MOMFLUX_ *)(_37w)).uw_));};}
  ...
  }iz_+=1;}while(iz_<=((ismp_+1)*(dnsdata_38h+1) / 1 )-1);}
  {
  register int md38;
while(!((*barrier_)==(ismp_)))sigsuspend(&oldmask);
  (*barrier_)=(md38=((ismp_)+1) % (1),md38>=0?md38:md38+(1));  kill(0,SIGUSR1);
  while(!((*barrier_)<=(ismp_)))sigsuspend(&oldmask);
};
   {int ix_=(ismp_*(nx_+1) / 1 ) ;do{{ { char *_39w;
_39w=ix_*VVplane_i+VVplane___;
{fft_6FFTU(VVplane__l,VVplane__h,VVplane__i,((char*)&(*(struct MOMFLUX_ *)(_39w)).uu_),VVplane__l,VVplane__h,VVplane__i,((char*)&(*(struct MOMFLUX_ *)(_39w)).uu_));}; {fft_6FFTU(VVplane__l,VVplane__h,VVplane__i,((char*)&(*(struct MOMFLUX_ *)(_39w)).uv_),VVplane__l,VVplane__h,VVplane__i,((char*)&(*(struct MOMFLUX_ *)(_39w)).uv_));}; {fft_6FFTU(VVplane__l,VVplane__h,VVplane__i,((char*)&(*(struct MOMFLUX_ *)(_39w)).vv_),VVplane__l,VVplane__h,VVplane__i,((char*)&(*(struct MOMFLUX_ *)(_39w)).vv_));}; {fft_6FFTU(VVplane__l,VVplane__h,VVplane__i,((char*)&(*(struct MOMFLUX_ *)(_39w)).vw_),VVplane__l,VVplane__h,VVplane__i,((char*)&(*(struct MOMFLUX_ *)(_39w)).vw_));}; {fft_6FFTU(VVplane__l,VVplane__h,VVplane__i,((char*)&(*(struct MOMFLUX_ *)(_39w)).ww_),VVplane__l,VVplane__h,VVplane__i,((char*)&(*(struct MOMFLUX_ *)(_39w)).ww_));}; {fft_6FFTU(VVplane__l,VVplane__h,VVplane__i,((char*)&(*(struct MOMFLUX_ *)(_39w)).uw_),VVplane__l,VVplane__h,VVplane__i,((char*)&(*(struct MOMFLUX_ *)(_39w)).uw_));};}
  /*! FOR ix=ismp TO nx BY nsmp*/
  }ix_+=1;}while(ix_<=((ismp_+1)*(nx_+1) / 1 )-1);}
